{
  mode: 'production',
  context: 'C:\\wamp64\\www\\Portfolio\\portfolio',
  devtool: 'source-map',
  output: {
    hashFunction: 'xxhash64',
    path: 'C:\\wamp64\\www\\Portfolio\\portfolio\\dist',
  ...
  resolve: {
    alias: {
      '@': 'C:\\wamp64\\www\\Portfolio\\portfolio\\src',
    ...
    modules: [
      'node_modules',
      'C:\\wamp64\\www\\Portfolio\\portfolio\\node_modules',
    ...
    rules: [
      ...
      /* config.module.rule('vue') */
      {
        ...
        use: [
          ...
          {
            loader: 'C:\\wamp64\\www\\Portfolio\\portfolio\\node_modules\\vue-loader\\dist\\index.js',
            options: {
              cacheDirectory: 'C:\\wamp64\\www\\Portfolio\\portfolio\\node_modules\\.cache\\vue-loader',
              cacheIdentifier: 'e07b1d00',
              babelParserPlugins: [
                'jsx',
                'classProperties',
                'decorators-legacy'
    ...
    new HtmlWebpackPlugin(
      {
        ...
        template: 'C:\\wamp64\\www\\Portfolio\\portfolio\\public\\index.html'
      }
    ),
    /* config.plugin('copy') */
    new CopyPlugin(
      {
        patterns: [
          {
            from: 'C:\\wamp64\\www\\Portfolio\\portfolio\\public',
            to: 'C:\\wamp64\\www\\Portfolio\\portfolio\\dist',
            toType: 'dir',
            noErrorOnMissing: true,
            globOptions: {
              ignore: [
                '**/.DS_Store',
                'C:/wamp64/www/Portfolio/portfolio/public/index.html'
              ]
            },
            info: {
              minimized: true
    ...
    new ESLintWebpackPlugin(
      {
        ...
        cwd: 'C:\\wamp64\\www\\Portfolio\\portfolio',
        cache: true,
        cacheLocation: 'C:\\wamp64\\www\\Portfolio\\portfolio\\node_modules\\.cache\\eslint\\0a601ca7.json',
        context: 'C:\\wamp64\\www\\Portfolio\\portfolio',
        failOnWarning: false,
        failOnError: true,
        eslintPath: 'C:\\wamp64\\www\\Portfolio\\portfolio\\node_modules\\eslint',
        formatter: 'stylish'
      }
    )
  ],
